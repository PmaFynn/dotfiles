...
vim.keymap.set('n', '<leader>zz', ':e ~/.zshrc<CR>')
vim.keymap.set('n', '<leader>w', ':e ~/mega/words.txt<CR>')
...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      -- C: compile current file into "run" and execute it
      vim.api.nvim_create_autocmd('FileType', {
        pattern = 'c',
        callback = function()
          -- % expands to current file name, %< expands to file name without extension
          vim.bo.makeprg = 'gcc % -o run && ./run'
        end,
      })
      ...
      vim.api.nvim_create_autocmd('FileType', {
        ...
        callback = function()
          -- % expands to current file name, %< expands to file name without extension
          vim.bo.makeprg = 'g++ -std=c++11 -02 -Wall % -o run && ./run'
        end,
      })
